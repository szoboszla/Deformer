...
class Exp_Main(Exp_Basic):
    ...
    def get_last_channel(self, x, y):
        last_channel_index = self.args.enc_in-1
        return x[:, :, last_channel_index:last_channel_index + 1], y[:, :, last_channel_index:last_channel_index + 1]
    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                batch_x, batch_y = self.get_last_channel(batch_x, batch_y)
    ...
    def test(self, setting, test=0):
        ...
        # preds = data_loader.inverse_transform(preds)
        # trues = data_loader.inverse_transform(trues)
        # scaler = StandardScaler()
        # preds = scaler.inverse_transform(preds)
        # trues = scaler.inverse_transform(trues)
        # dataset = data_loader.Dataset_Custom(root_path, flag='test')
